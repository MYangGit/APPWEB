...
export default {
    ...
    mounted() {
        ...
        eventBus.$on('move', (isDownward, isRightward, element) => {
            this.showLine(isDownward, isRightward, element)
        })
    ...
    methods: {
        ...
        showLine(isDownward, isRightward, element) {
            const lines = this.$refs
            const components = this.componentData
            const curComponentStyle = getComponentRotatedStyle(element.style)
            ...
            components.forEach((component) => {
                ...
                Object.keys(conditions).forEach((key) => {
                    ...
                    conditions[key].forEach((condition) => {
                        ...
                        if (condition.lineNode) condition.lineNode.style[key] = `${condition.lineShift}px`
        ...
        translatecurComponentShift(key, condition, curComponentStyle, element) {
