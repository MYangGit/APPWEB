<template>
    <div class="animation-list">
        ...
        <!-- 选择动画 -->
        <Modal v-model="isShowAnimation" title="选择动画" :showBtns="false">
        ...
        <AnimationSettingModal
            v-model="isShowAnimationSetting"
            :cur-index="curIndex"
...
export default {
    ...
    methods: {
        addAnimation(animate) {
            rootStore.dataCenter.addAnimation(animate)
        ...
        removeAnimation(index) {
            rootStore.dataCenter.removeAnimation(index);
