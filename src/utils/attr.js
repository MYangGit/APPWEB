export const styleData = [
    ...
    { key: 'width', label: '宽' },
    { key: 'height', label: '高' },
    { key: 'fixedWidth', label: '固定宽' },
    { key: 'fixedHeight', label: '固定高' },
    { key: 'color', label: '颜色' },
    { key: 'marginLeft', label: '左边距' },
    { key: 'backgroundColor', label: '背景色' },
    { key: 'borderWidth', label: '边框宽度' },
    { key: 'borderBottomWidth', label: '下边框宽度' },
...
export const selectKey = ['textAlign', 'borderStyle', 'verticalAlign', 'display'];

export const optionMap = {
    textAlign: textAlignOptions,
    borderStyle: borderStyleOptions,
    verticalAlign: verticalAlignOptions,
    display: dispalyOptions,
};
