...
export function getShapeStyle(style) {
    ...
    ['width', 'height', 'top', 'left', 'rotate'].forEach((attr) => {
        if (attr != 'rotate') {
            result[attr] = style[attr] + (style[attr] && !style[attr].toString().includes('%') ? 'px' : '');
        } else {
...
const needUnit = ['fontSize', 'width', 'height', 'top', 'left', 'borderWidth', 'borderBottomWidth', 'letterSpacing', 'borderRadius', 'marginLeft', 'padding'];
            ...
            if (key != 'rotate') {
                if (style[key] !== '') {
                    ...
                    if (needUnit.includes(key)) {
                        result[key] += result[key] && !result[key].toString().includes('%') ? 'px' : '';
                    }
                }
            } else {
